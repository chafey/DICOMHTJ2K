...
openjphjs.onRuntimeInitialized = async (_) => {
  try {
    ...
    for (let i = 0; i < numberOfFrames; i++) {
      ...
      console.log('frame ', i, ' compression ratio: ', (framePixelData.length / encodedBytes.length).toFixed(2), ":1" )
    ...
    //////////////////////////////////////////////////////////////////
    writeDICOMP10File(isUsingColorTransform, dataset, meta, encodedFrames, outputFilePath)
